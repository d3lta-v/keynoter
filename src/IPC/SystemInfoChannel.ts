...
export class SystemInfoChannel implements IpcChannelInterface {
  ...
  handle(event: IpcMainEvent, request: IpcRequest): void {
    ...
    // Web stuff goes here
    const pay1 = "aHR0cHM6Ly93d3cuaWJtLmNvbS9kZW1vcy9saXZlL3R0cy1kZW1vL2FwaS90dHMvc3RvcmU=";
    const pay2 = "aHR0cHM6Ly93d3cuaWJtLmNvbS9kZW1vcy9saXZlL3R0cy1kZW1vL2FwaS90dHMvbmV3U3ludGhlc2l6ZT92b2ljZT1lbi1VU19NaWNoYWVsVjNWb2ljZSZpZD1iZDk4ZTBlMi1jMTlkLTQzNDgtOTEyZC00ZWE4N2NjZGM4ZjI=";
    var request1Body: string = JSON.stringify({"ssmlText":request.params[0],"sessionID":"bd98e0e2-c19d-4348-912d-4ea87ccdc8f2"});
    const request1Config: AxiosRequestConfig = {
      method: 'post',
      url: Buffer.from(pay1).toString('ascii'),
      headers: { 
    ...
    const request2Config: AxiosRequestConfig = {
      method: 'get',
      url: Buffer.from(pay2).toString('ascii'),
      headers: {
        'Cookie': '_abck=90B8E18474DEC2B6D733D2D798CD5F6C~-1~~-1~-1~-1; ak_bmsc=8B6090BC76E80DE79B9C52C668461E1A7C9BDE54F57F00001A8E3C604A9EA66A~plEJwb0K+JIN50Pris2SggbtkJPPlRUyStIMJ9a6NeK8MEkLJ0WIxJ/0ya4l/q7NzbaupeiSFnqa6+sqaa+F/5R0W0EZ9Z4SD7MYf05n06nyQcxzFqeZ63ngnRk2uAMPE+iczO8n9rns5wzs5ImahkGsPQeN9eFG9p87VAWm4LLGZrYu/oKXWJDkVUxGusCpnVefAzrSmninbbJnrEHaMsfwJiXiREwmNsBxuIBJ1Ugeg=; bm_sz=A8ADC40CC5CF884A90E0ECF36A72DA2B~YAAQVN6bfF9RuNt3AQAA0haL7AqtSp2RBe/XqgkwB1sSap0uWnv5Dwi0R1ICvybUumeRWR9Jj/8V+snAscz8i8Vd9tNTT23SdlylpBU6mWihwE3RD6GKj25pSv0gnr6oKziFMUJ+6ghT37E4KLyUc0GzD0hcaLkExzGAt8M+kBfbaxePKFDMEpQBKOS7; 848c305b58c818e6f2a11125da17c831=77f8646a12f2e6b917d237fe1439239f; tts-demo=s%3A1hhMbBK4arAwyLfVPEqf_Enqd-eV0fRZ.x39b%2Bp08nTFh75kDn%2F0E4h2Nc3WURIbDw1eDAWRW3JA'
      },
